...
class TrueRedisTestCase(TestCase):
    ...
    def mocketize_teardown(self):
        self.assertEqual(len(Mocket._record), 0)
...
class RedisTestCase(TestCase):
    ...
    def test_incr(self):
        ...
        self.assertEqual(Mocket._record[0].request.data, b'*3\r\n$6\r\nINCRBY\r\n$7\r\ncounter\r\n$1\r\n1\r\n')
        self.assertEqual(Mocket._record[1].request.data, b'*3\r\n$6\r\nINCRBY\r\n$7\r\ncounter\r\n$1\r\n1\r\n')
        self.assertEqual(Mocket._record[2].request.data, b'*3\r\n$6\r\nINCRBY\r\n$7\r\ncounter\r\n$1\r\n1\r\n')
    ...
    def test_hgetall(self):
        ...
        self.assertEqual(self.rclient.hgetall('hash'), h)
        self.assertEqual(len(Mocket._record), 1)
        self.assertEqual(Mocket._record[0].request.data, b'*2\r\n$7\r\nHGETALL\r\n$4\r\nhash\r\n')
